...
export
{
	...
	option t1021_002_report_option = T;
	...
	option t1016_report_option = T;
	option t1018_report_option = T;
	option t1033_report_option = T;
	option t1049_report_option = T;
	option t1069_report_option = T;
	option t1082_report_option = T;
	option t1083_report_option = T;
	option t1087_report_option = T;
	option t1124_report_option = T;
	option t1135_report_option = T;
